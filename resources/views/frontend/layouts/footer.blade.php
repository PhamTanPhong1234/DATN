                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="footer-logo">
                            <a href="index.html"><img src="{{asset('assets/images/logo/favicon.png')}}" alt="Logo Ecolife" width="200px" /></a>
                        </div>
                        <!-- Giới thiệu footer -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="single-wedge">
                            ...
                            <div class="img_app">
                                <a href="#"><img src="{{asset('assets/images/icons/app_store.png')}}" alt="App Store" /></a>
                                <a href="#"><img src="{{asset('assets/images/icons/google_play.png')}}" alt="Google Play" /></a>
                            </div>
                        </div>
                    </div>
                </div>
